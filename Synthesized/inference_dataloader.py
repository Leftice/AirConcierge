...
def Inference_loader_2(batch_size, toy, max_len=None, need_shuffle=False, mask=False, only_f=False, dev=False, n_sample=-1, small_n=30):
    global eod_id
    global smallkb_n
    smallkb_n = small_n
    ...
    if dev:
        ...
        kb_file = 'Inference_Bleu/SQL/dev_sql/simulate_DB/filtered.kb'
        filtered_index_path = 'Inference_Bleu/SQL/dev_sql/simulate_DB/filtered_index.kb'
        turn_gate_path = 'Inference_Bleu/SQL/prior_gate.txt'
    else:
        src_data_file = 'data/synthesized/tokenized/dev.infer.src.data'
        tar_data_file = 'data/synthesized/tokenized/dev.infer.tar.data'
