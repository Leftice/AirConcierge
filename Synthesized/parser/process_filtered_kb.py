...
if args.train:
    ...
    true_query_file = '../data/synthesized/SQL/train.sql.txt'
    rf_fp = open('../data/synthesized/SQL/filtered_kb', 'w')
    ...
    true_query_file = '../data/synthesized/SQL/dev/dev.sql.txt'
    rf_fp = open('../data/synthesized/SQL/dev/filtered_kb', 'w')
...
def simulate_DB(sents, kb, truth_gate, true_query, condiction_num):
    ...
    print('kb_len : ', kb_len)
    print('error_truth : ', error, ' / ', len(kb_sents))
...
print('End Process filtered_kb file ~ ')