...
if args.dev:
    if not os.path.exists('dev_label_result/'):
        os.makedirs('dev_label_result/')
    if not os.path.exists('dev_label_result_fail/'):
        os.makedirs('dev_label_result_fail/')
    data_fp = open('../data/airdialogue/tokenized/dev.data', "r")
    kb_fp = open('../data/airdialogue/tokenized/dev.kb', "r")
    state_tracking_fp = open('../data/SQL/dev/State_Tracking.txt', 'w')

    bb_fp = open('dev_label_result/Book_Book.txt', 'w')
    bn_fp = open('dev_label_result/Book_No_flight.txt', 'w')
    chch_fp = open('dev_label_result/Change_Change.txt', 'w')
    chno_fp = open('dev_label_result/Change_No_flight.txt', 'w')
    chnor_fp = open('dev_label_result/Change_No_reservation.txt', 'w')
    cc_fp = open('dev_label_result/Cancel_Cancel.txt', 'w')
    cnor_fp = open('dev_label_result/Cancel_No_reservation.txt', 'w')
    error_report_fp = open('Error.txt', 'w')
    fail_bb_fp = open('dev_label_result_fail/Book_Book_fail.txt', 'w')
    fail_bn_fp = open('dev_label_result_fail/Book_No_flight_fail.txt', 'w')
    fail_chch_fp = open('dev_label_result_fail/Change_Change_fail.txt', 'w')
    fail_chno_fp = open('dev_label_result_fail/Change_No_flight_fail.txt', 'w')
    fail_chnor_fp = open('dev_label_result_fail/Change_No_reservation_fail.txt', 'w')
    fail_cc_fp = open('dev_label_result_fail/Cancel_Cancel_fail.txt', 'w')
    fail_cnor_fp = open('dev_label_result_fail/Cancel_No_reservation_fail.txt', 'w')
elif args.train:
    if not os.path.exists('train_label_result/'):
        os.makedirs('train_label_result/')
    if not os.path.exists('train_label_result_fail/'):
        os.makedirs('train_label_result_fail/')
    data_fp = open('../data/airdialogue/tokenized/train.data', "r")
    kb_fp = open('../data/airdialogue/tokenized/train.kb', "r")
    state_tracking_fp = open('../data/SQL/State_Tracking.txt', 'w')

    bb_fp = open('train_label_result/Book_Book.txt', 'w')
    bn_fp = open('train_label_result/Book_No_flight.txt', 'w')
    chch_fp = open('train_label_result/Change_Change.txt', 'w')
    chno_fp = open('train_label_result/Change_No_flight.txt', 'w')
    chnor_fp = open('train_label_result/Change_No_reservation.txt', 'w')
    cc_fp = open('train_label_result/Cancel_Cancel.txt', 'w')
    cnor_fp = open('train_label_result/Cancel_No_reservation.txt', 'w')
    error_report_fp = open('Error.txt', 'w')
    fail_bb_fp = open('train_label_result_fail/Book_Book_fail.txt', 'w')
    fail_bn_fp = open('train_label_result_fail/Book_No_flight_fail.txt', 'w')
    fail_chch_fp = open('train_label_result_fail/Change_Change_fail.txt', 'w')
    fail_chno_fp = open('train_label_result_fail/Change_No_flight_fail.txt', 'w')
    fail_chnor_fp = open('train_label_result_fail/Change_No_reservation_fail.txt', 'w')
    fail_cc_fp = open('train_label_result_fail/Cancel_Cancel_fail.txt', 'w')
    fail_cnor_fp = open('train_label_result_fail/Cancel_No_reservation_fail.txt', 'w')
else:
...
for dialogue_lines in tqdm(iter(data_fp)):
