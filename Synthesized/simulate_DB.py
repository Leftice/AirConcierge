...
if args.dev:
    ...
    # eval step sql
    query_file = 'dev_sql/dev_predict_query'
    query2_file = 'dev_sql/dev_simple' 
    true_query_file = 'dev_sql/dev_gt_query'
    gate_file = 'dev_sql/dev_gate'
    # output file
    if not os.path.exists('dev_sql/simulate_DB/'):
        os.makedirs('dev_sql/simulate_DB/')
    small_fp = open('dev_sql/simulate_DB/small_db.kb', 'w')
    r_fp = open('dev_sql/simulate_DB/record', 'w')
    rf_fp = open('dev_sql/simulate_DB/filtered_kb', 'w')
