...
def SelfPlayEval_loader_2(batch_size, toy, max_len=None, need_shuffle=False, mask=False, only_f=False, dev=False, n_sample=-1, small_n=30):
    global eod_id
    global smallkb_n
    smallkb_n = small_n
    ...
    kb_file = 'Self_Play_Eval/SQL/dev_sql/simulate_DB/filtered.kb'
    filtered_index_path = 'Self_Play_Eval/SQL/dev_sql/simulate_DB/filtered_index.kb'
    turn_gate_path = 'Self_Play_Eval/SQL/prior_gate.txt'
