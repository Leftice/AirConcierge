...
class SupervisedSelfPlayEval(object):
    ...
    def _test_epoches_t1t2_self_play_eval(self, dataloader, model, start_step, save_dir='runs/exp', args=None):
        ...
        if not os.path.exists('Self_Play_Eval/Result/'):
            os.makedirs('Self_Play_Eval/Result/')
        t_fp = open('Self_Play_Eval/Result/self_output.data', 'w')
        a_fp = open('Self_Play_Eval/Result/self_output_action.data', 'w')
