...
class Seq2seq(nn.Module):
    ...
    def __init__(self, args, decoder1, decoder2, decoder3=None, decode_function=F.log_softmax):
        ...
        self.intent_encoder_rnn = nn.GRU(args.intent_input_size, args.intent_hidden_size, args.intent_n_layer, batch_first=True, bidirectional=args.intent_bidirectional, dropout=args.intent_dropout_p)
