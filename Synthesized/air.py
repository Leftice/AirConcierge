...
from self_play_dataloader import *
...
if args.infer_bleu_prior:
    ...
    dataloader, corpus = Inference_loader(args.batch_size, args.toy, args.max_len, args.shuffle, args.mask, args.only_f, args.dev, args.n_sample, args.smallkb_n)
elif args.infer_bleu:
    print('Inference bleu!')
    dataloader, corpus = Inference_loader_2(args.batch_size, args.toy, args.max_len, args.shuffle, args.mask, args.only_f, args.dev, args.n_sample, args.smallkb_n)
elif args.self_play_eval_prior:
    print('Self play prior !')
    dataloader, corpus = SelfPlayEval_loader(args.batch_size, args.toy, args.max_len, args.shuffle, args.mask, args.only_f, args.dev, args.n_sample, args.smallkb_n)
elif args.self_play_eval:
    print('Self play eval !')
    dataloader, corpus = SelfPlayEval_loader_2(args.batch_size, args.toy, args.max_len, args.shuffle, args.mask, args.only_f, args.dev, args.n_sample, args.smallkb_n)
else:
    print('Supervised dataloader !')
    dataloader, corpus = loader(args.batch_size, args.toy, args.max_len, args.shuffle, args.mask, args.only_f, args.dev, args.n_sample, args.smallkb_n)
...
if args.action_att : 
    print('Using action attention !')
else:
    print('Using normal NN !')
