...
if args.dev:
    ...
    query_file = data_path + 'SQL/dev_sql/dev_predict_query'
    query2_file = data_path + 'SQL/dev_sql/dev_simple' 
    true_query_file = data_path + 'SQL/dev_sql/dev_gt_query'
    gate_file = data_path + 'SQL/dev_sql/dev_gate'

    if not os.path.exists(data_path + 'SQL/dev_sql/simulate_DB/'):
        os.makedirs(data_path + 'SQL/dev_sql/simulate_DB/')
    small_fp = open(data_path + 'SQL/dev_sql/simulate_DB/small_db.kb', 'w')
    r_fp = open(data_path + 'SQL/dev_sql/simulate_DB/record', 'w')
    rf_fp = open(data_path + 'SQL/dev_sql/simulate_DB/filtered_kb', 'w')
elif args.train:
